...
The managed Default-profile settings and keybindings are also copied into every existing named Cursor profile after apply. This keeps existing workspace/profile associations intact while making the portable configuration authoritative across profiles and machines.
